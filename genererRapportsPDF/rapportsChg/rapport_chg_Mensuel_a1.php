...
function designA1(){
    ...
    $row10 = mysqli_fetch_assoc($result10);
            ...
            $row10 = mysqli_fetch_assoc($result10);
               $output .= '<tr style="text-align:center;font-size:12px;"> <td> ' . $row1["nomDesignA1"]. '</td>';
                while ($row3 = mysqli_fetch_assoc($result3)){
                    ...
                    $result0 = mysqli_query($conn, $sql0);
                    while($row0 = mysqli_fetch_assoc($result0)) {
                        $sql2 = "SELECT effectif, mtA1 FROM designA1_sce_periode_data where periode='".$GLOBALS['periode']."' and mois='".$GLOBALS['mois']."' and annee=".$GLOBALS['annee']." and  codeSce = $row0[code_sce] and codeDesignA1=$row1[code_designA1]";
            ...
            $sql6= "SELECT sum(effectif) as somEffectif ,sum(mtA1) as somMt FROM designA1_sce_periode_data where periode='".$GLOBALS['periode']."' and mois='".$GLOBALS['mois']."' and annee=".$GLOBALS['annee']." and  codeDesignA1= $row1[code_designA1]";
            ...
            if ( $row1['categorie'] != $row10 ['categorie']){
                ...
                $result3 = mysqli_query($conn, $sql3);
                    while ($row3 = mysqli_fetch_assoc($result3)){
                        ...
                        while($row0 = mysqli_fetch_assoc($result0)) {
                            $sql4 = "SELECT sum(effectif) as somEffectif ,sum(mtA1) as somMt FROM designA1_sce_periode_data 
                                        where periode='".$GLOBALS['periode']."' and mois='".$GLOBALS['mois']."' and annee=".$GLOBALS['annee']." and codeSce= $row0[code_sce] and categorie= '".$row1["categorie"]."'";
                    ...
                    where periode='".$GLOBALS['periode']."' and mois='".$GLOBALS['mois']."' and annee=".$GLOBALS['annee']." and categorie= '".$row1["categorie"]."'";
    ...
    $row10 = mysqli_fetch_assoc($result10);
            while($row1 = mysqli_fetch_assoc($result1)) {
               ...
               $n='1';               
                ...
                where periode='".$GLOBALS['periode']."' and mois='".$GLOBALS['mois']."' and annee=".$GLOBALS['annee']." and codeDesignA1= $row1[code_designA1]";
                $result6 = mysqli_query($conn, $sql6);
                $row6 = mysqli_fetch_assoc($result6);
                $output .= '<td>' .$row6["somEffectif"]. '</td>
                            <td>' .$row6["somMt"]. '</td>';
...
function totalSce_pdf_p2(){
    ...
    while ($row3 = mysqli_fetch_assoc($result3)){
        ...
        //Total
        $sql8 = "SELECT sum(effectif) as somEffectif ,sum(mtA1) as somMt FROM designA1_sce_periode_data where periode='".$GLOBALS['periode']."' and mois='".$GLOBALS['mois']."' and annee=".$GLOBALS['annee']."";
        $result8 = mysqli_query($conn, $sql8);
        $row8 = mysqli_fetch_assoc($result8);
        $output .= '<td>' .$row8["somEffectif"]. '</td>
                <td>' .$row8["somMt"]. '</td>';
...
if(isset($_POST["generate_pdf"]))  
 {  
      ...
      $obj_pdf->Output('A1_Mensuel_'.$GLOBALS['mois'].'_'.$GLOBALS['annee'].'.pdf', 'I'); 
    }  
 ?>  
 <!DOCTYPE html>  
 <html>  
