...
<body>
        ...
        <div class="page-content row css-table" >
          ...
          <div class="table_content">
            ...
            <div class=" demo">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    <?php
                        echo "
                              <td>
                                <a class='ask' href='maj_act.php?table=".$table."&sup_col1=".$row2[$i]."&sup_col2=".$row2[$i+1]."&sup_col3=".$row2[$i+2]."'>
                                  <img src='../../images/trash.png' alt='' title='' border='0' />
                                </a>
                              </td>
                          ";
              ...
              <a href="<?php echo"insertion_act.php?table=".$table."";?>" class="bt_green"><span class="bt_green_lft"></span><strong>Insérer</strong><span class="bt_green_r"></span></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- edité Table -->
  <script src="../../js/index-mod-act.js"></script>
  <script>
    $('table').SetEditable();
    </script>
<!--/.container.demo -->
