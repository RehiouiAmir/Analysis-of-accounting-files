...
<head>
  ...
  <title>Acceuil | Panneau Admin</title>
    ...
    <link rel="stylesheet" href="css/style.css?version=22"></link>
  ...
  <div class="l-sidebar">
    ...
    <div class="l-sidebar__content">
      <nav class="c-menu js-menu">
        <ul class="u-list">
          <a href="acceuil.php" style="text-decoration: none;"><li class="c-menu__item is-active" data-toggle="tooltip" title="Acceuil">
