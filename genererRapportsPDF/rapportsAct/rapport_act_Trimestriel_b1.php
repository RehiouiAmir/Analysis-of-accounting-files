...
function designB1(){
    ...
    $sql3 = "SELECT code_section,nomSection FROM section  order by ordreSection";    
    $result3 = mysqli_query($conn, $sql3);
    $sql1 = "SELECT code_designB1, nomDesignB1 FROM designB1 order by nomDesignB1  DESC";
    $result1 = mysqli_query($conn, $sql1);    
    $result10= mysqli_query($conn, $sql1);
    $row10 = mysqli_fetch_assoc($result10);
            while($row1 = mysqli_fetch_assoc($result1)) {
            $row10 = mysqli_fetch_assoc($result10);
               $output .= '<tr style="text-align:center;font-size:12px;"> <td> ' . $row1["nomDesignB1"]. '</td>';
                while ($row3 = mysqli_fetch_assoc($result3)){
                    $sql0 = "SELECT code_sce,nomSce FROM service where codeSection= $row3[code_section] order by ordre";
                    $result0 = mysqli_query($conn, $sql0);
                    while($row0 = mysqli_fetch_assoc($result0)) {
                        $sql2 = "SELECT  nbreB1 FROM designB1_sce_periode_data where periode='".$GLOBALS['periode']."' and trimestre='".$GLOBALS['trimestre']."' and annee=".$GLOBALS['annee']." and  codeSce = $row0[code_sce] and codeDesignB1=$row1[code_designB1]";
                        $result2 = mysqli_query($conn, $sql2);
                        $row2 = mysqli_fetch_assoc($result2);  
                        $output .= ' <td>'. $row2["nbreB1"]. '</td>';
                    }
            }
            $sql6= "SELECT sum(nbreB1) as somnbre FROM designB1_sce_periode_data designB1_sce_periode_data where periode='".$GLOBALS['periode']."' and trimestre='".$GLOBALS['trimestre']."' and annee=".$GLOBALS['annee']." and  codeDesignB1= $row1[code_designB1]";
...
function totalSce(){
    ...
    while ($row3 = mysqli_fetch_assoc($result3)){
        ...
        while(($row0 = mysqli_fetch_assoc($result0)) and $i<4) {
            $sql4 = "SELECT sum(nbreB1) as somnbre FROM designB1_sce_periode_data 
        ...
        //Total
        $sql8 = "SELECT sum(nbreB1) as somnbre FROM designB1_sce_periode_data 
...
function designB1_pdf_p1(){
    ...
    $row10 = mysqli_fetch_assoc($result10);
            while($row1 = mysqli_fetch_assoc($result1)) {
               $row10 = mysqli_fetch_assoc($result10);
               $output .= '<tr style="font-size:7px;text-align:center;"> <td> ' . $row1["nomDesignB1"]. '</td>';
               $n='1';               
                while ($row3 = mysqli_fetch_assoc($result3)){
                    $sql0 = "SELECT code_sce,nomSce FROM service where codeSection= $row3[code_section] order by ordre";
                    $result0 = mysqli_query($conn, $sql0);
    ...
    $row10 = mysqli_fetch_assoc($result10);
            while($row1 = mysqli_fetch_assoc($result1)) {
               ...
               $n='1';               
                ...
                $sql6= "SELECT sum(nbreB1) as somnbre FROM designB1_sce_periode_data 
                where periode='".$GLOBALS['periode']."' and trimestre='".$GLOBALS['trimestre']."' and annee=".$GLOBALS['annee']." and codeDesignB1= $row1[code_designB1]";
                $result6 = mysqli_query($conn, $sql6);
                $row6 = mysqli_fetch_assoc($result6);
                $output .= '<td>' .$row6["somnbre"]. '</td>';
                $output .= '</tr>';
...
function totalSce_pdf_p2(){
    ...
    while ($row3 = mysqli_fetch_assoc($result3)){
        ...
        //Total
        $sql8 = "SELECT sum(nbreB1) as somnbre FROM designB1_sce_periode_data where periode='".$GLOBALS['periode']."' and trimestre='".$GLOBALS['trimestre']."' and annee=".$GLOBALS['annee']."";
        $result8 = mysqli_query($conn, $sql8);
        $row8 = mysqli_fetch_assoc($result8);
        $output .= '<td>'.$row8["somnbre"]. '</td>';
        $output .= '</tr>';
 ...
 <html>  
    ...
    <body>  
                ...
                <br>
                    ...
                    <h5 style="margin-left:78%;">TABLEAU B1 </h5>
                <table>
                <tr>
                ...
                <?php
                    ...
                    //Affichage des designB1- val_nbrerepas&Montant
                        $designB1= designB1();
                        echo "".$designB1."";
